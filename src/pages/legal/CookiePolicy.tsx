...
export default function CookiePolicy() {
  return (
    <>
      <PageMeta title="Cookie Policy | Voting Pro" description="Learn about how Voting Pro uses cookies and similar technologies." canonicalPath="/cookies" breadcrumbs={[{ name: "Home", path: "/" }, { name: "Cookie Policy", path: "/cookies" }]} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <section className="space-y-3">
              ...
              <p>Voting Pro uses cookies and similar technologies for the following purposes:</p>
            ...
            <section className="space-y-3">
              ...
              <p>If you have any questions about our use of cookies, please contact us through our Support page or email us at privacy@votingpro.com.</p>
            </section>
          </div>
        </div>
      </div>
