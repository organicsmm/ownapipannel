...
export default function RefundPolicy() {
  return (
    <>
      <PageMeta title="Refund Policy | Voting Pro" description="Understand Voting Pro's refund and cancellation policies." canonicalPath="/refund" breadcrumbs={[{ name: "Home", path: "/" }, { name: "Refund Policy", path: "/refund" }]} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="flex gap-3 p-4 mb-8 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-400/90">
            ...
            <p className="text-sm leading-relaxed">
              <strong className="text-amber-400">Notice:</strong> Voting Pro provides <strong>intangible digital services</strong>. Once services are delivered, they cannot be reversed or returned. Please read this policy carefully before making a purchase.
            </p>
          </div>
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <section className="space-y-3">
              ...
              <p>Funds added to your Voting Pro wallet are considered <strong className="text-foreground">service credits</strong> and are generally non-refundable. Refunds for wallet deposits may be considered only under:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section className="space-y-3">
              ...
              <p>If you disagree with a refund decision, you may escalate by emailing <strong className="text-foreground">support@votingpro.com</strong> with additional evidence. We will review escalated cases within 7 business days. Our decision on escalated cases is final.</p>
            </section>
