...
export default function PrivacyPolicy() {
  return (
    <>
      <PageMeta title="Privacy Policy | Boostly Pro" description="Learn how Boostly Pro collects, uses, and protects your personal data." canonicalPath="/privacy" breadcrumbs={[{ name: "Home", path: "/" }, { name: "Privacy Policy", path: "/privacy" }]} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            <section className="space-y-3">
              ...
              <p>Boostly Pro ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform and services. Please read this policy carefully to understand our practices regarding your personal data.</p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>If you have questions or concerns about this Privacy Policy or our data practices, please contact us through our Support page or email us at privacy@boostlypro.com.</p>
            </section>
          </div>
        </div>
      </div>
