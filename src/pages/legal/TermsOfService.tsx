...
export default function TermsOfService() {
  return (
    <>
      <PageMeta title="Terms of Service | Boostly Pro" description="Read the Terms of Service for Boostly Pro platform." canonicalPath="/terms" breadcrumbs={[{ name: "Home", path: "/" }, { name: "Terms of Service", path: "/terms" }]} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="flex gap-3 p-4 mb-8 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-400/90">
            ...
            <p className="text-sm leading-relaxed">
              <strong className="text-amber-400">Important:</strong> By accessing or using Boostly Pro, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. If you do not agree, you must immediately cease using the Platform.
            </p>
          </div>
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <section className="space-y-3">
              ...
              <div className="p-4 rounded-xl bg-red-500/8 border border-red-500/15 space-y-2">
                ...
                <p>By making a payment to Boostly Pro, you explicitly agree that:</p>
                <ul className="list-disc pl-6 space-y-1">
            ...
            <section className="space-y-3">
              ...
              <p>By using Boostly Pro, you acknowledge and agree that:</p>
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>Boostly Pro is not responsible for any action taken by social media platforms against your account as a result of your use of our services</li>
                <li>You will not hold Boostly Pro liable for any legal consequences arising from your use of our services</li>
            ...
            <section className="space-y-3">
              ...
              <p>All content, features, and functionality of the Platform—including but not limited to text, graphics, logos, icons, software, and algorithms—are the exclusive property of Boostly Pro and are protected by international copyright, trademark, and other intellectual property laws.</p>
            </section>

            <section className="space-y-3">
              <h2 className="text-xl font-semibold text-foreground">13. Limitation of Liability</h2>
              <p>To the maximum extent permitted by law, Boostly Pro shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section className="space-y-3">
              ...
              <p>You agree to indemnify, defend, and hold harmless Boostly Pro and its officers, directors, employees, and agents from and against any claims, liabilities, damages, losses, and expenses arising from:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section className="space-y-3">
              ...
              <p>If you have any questions about these Terms, please contact us through our Support page or email us at <strong className="text-foreground">support@boostlypro.com</strong>. We are committed to resolving disputes amicably before any legal action is considered by either party.</p>
            </section>
